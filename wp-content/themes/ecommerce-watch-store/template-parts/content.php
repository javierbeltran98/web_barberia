    ...
    if($ecommerce_watch_store_theme_lay == 'Default'){ ?>
      <div class="row">
        ...
        <article class="new-text <?php if(has_post_thumbnail() && get_theme_mod( 'ecommerce_watch_store_featured_image_hide_show',true) == 1) { ?>col-lg-6 col-md-6" <?php } else { ?>col-lg-12 col-md-12" <?php } ?>>
          ...
          <?php if( get_theme_mod( 'ecommerce_watch_store_blog_toggle_postdate',true) == 1 || get_theme_mod( 'ecommerce_watch_store_blog_toggle_author',true) == 1 || get_theme_mod( 'ecommerce_watch_store_blog_toggle_comments',true) == 1 || get_theme_mod( 'ecommerce_watch_store_blog_toggle_time',true) == 1) { ?>
            <div class="post-info p-2 my-3">
              <?php if(get_theme_mod('ecommerce_watch_store_blog_toggle_postdate',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('ecommerce_watch_store_toggle_postdate_icon','fas fa-calendar-alt')); ?> me-2"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $ecommerce_watch_store_archive_year, $ecommerce_watch_store_archive_month, $ecommerce_watch_store_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span><?php echo esc_html(get_theme_mod('ecommerce_watch_store_meta_field_separator', '|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('ecommerce_watch_store_blog_toggle_author',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('ecommerce_watch_store_toggle_author_icon','fas fa-user')); ?> me-2"></i><span class="entry-author"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' )) ); ?>"><?php the_author(); ?><span class="screen-reader-text"><?php the_author(); ?></span></a></span><span><?php echo esc_html(get_theme_mod('ecommerce_watch_store_meta_field_separator', '|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('ecommerce_watch_store_blog_toggle_comments',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('ecommerce_watch_store_toggle_comments_icon','fa fa-comments')); ?> me-2" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'ecommerce-watch-store'), __('0 Comments', 'ecommerce-watch-store'), __('% Comments', 'ecommerce-watch-store') ); ?></span><span><?php echo esc_html(get_theme_mod('ecommerce_watch_store_meta_field_separator', '|'));?></span>
              <?php } ?>

              <?php if(get_theme_mod('ecommerce_watch_store_blog_toggle_time',true)==1){ ?>
                <i class="<?php echo esc_attr(get_theme_mod('ecommerce_watch_store_toggle_time_icon','fas fa-clock')); ?> me-2"></i><span class="entry-time"><?php echo esc_html( get_the_time() ); ?></span>
              <?php } ?>

                <?php ecommerce_watch_store_edit_link(); ?>
            </div>
          <?php } ?>
          <p class="mb-0">
