	    ...
	    <div class="grid-post-main-box p-3 mb-3 wow zoomIn" data-wow-duration="2s">
	        ...
	        <div class="new-text">
	        	<div class="entry-content">
	        		<p>
			          <?php $ecommerce_watch_store_theme_lay = get_theme_mod( 'ecommerce_watch_store_grid_excerpt_settings','Excerpt');
				          if($ecommerce_watch_store_theme_lay == 'Content'){ ?>
				            <?php the_content(); ?>
				          <?php }
				          if($ecommerce_watch_store_theme_lay == 'Excerpt'){ ?>
				            <?php if(get_the_excerpt()) { ?>
				              <?php $ecommerce_watch_store_excerpt = get_the_excerpt(); echo esc_html( ecommerce_watch_store_string_limit_words( $ecommerce_watch_store_excerpt, esc_attr(get_theme_mod('ecommerce_watch_store_grid_excerpt_number','30')))); ?><?php echo esc_html(get_theme_mod('ecommerce_watch_store_grid_excerpt_suffix',''));?>
				            <?php }?>
				          <?php }?>
			        </p>
	        	</div>
